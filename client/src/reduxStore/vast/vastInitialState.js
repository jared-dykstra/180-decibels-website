...
export default {
  ...
  model: Immutable.from({
    nodes: [
      {
        id: 'fae3763d-2cb9-4d54-9132-e34bc14f45f2',
        label: 'Person A',
        type: NODE_TYPE_PERSON
      },
      {
        id: '9a5cbd26-98d5-4057-977a-88f6d776542c',
        label: 'Person B',
        type: NODE_TYPE_PERSON
      },
      {
        id: 'f00da641-6da9-4688-8763-9c4dac9d37eb',
        label: 'Accountability 1',
        type: NODE_TYPE_ACCOUNTABILITY
      },
      {
        id: 'c8566db9-bf1f-45b0-b968-d79f22ce76c2',
        label: 'Accountability 2',
        type: NODE_TYPE_ACCOUNTABILITY
      },
      {
        id: '95c54d46-0f7b-49ba-96cb-e4a5b96734fc',
