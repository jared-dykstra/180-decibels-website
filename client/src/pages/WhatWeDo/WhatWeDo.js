      ...
      <Paper className={classes.paper}>
        <section>
          ...
          <Typography variant="body1" paragraph>
            ...
            saturate your organization with a proven process for getting where
            you want to go.
          </Typography>
          ...
          >
            <em>
              Our mission is to measurably improve team productivity and
              maximize profitability.
            </em>
          </Typography>

          <Typography variant="body1" paragraph>
            Maybe your company grew very quickly or maybe you have people in
            seats that were never trained to manage…that is all very normal. But
            an undirected team operates naturally in survival mode which quickly
            leads to overwhelm. Without clear accountability and day-to-day
            discipline, teams get bogged down and performance suffers (along
            with morale).
          </Typography>
          ...
          >
            ...
            least. From the first few questions I knew that I had much to
            discover and was about to enter a learning cycle that would take me
            to a great future. I am discovering new aspects of myself and how I
            can cooperate and lead my team.
          </Quote>
        ...
        <section id="services">
          ...
          <h2>Operations</h2>
          <Typography variant="body1" paragraph>
            We focus on the People side of Operations. As managers we really
            only have one accountability: to get the maximum amount of
            productivity out of our teams at the lowest cost possible. We work
            with clients to remove complexity and get there quickly and easily.
          </Typography>
          ...
          <Typography variant="body1" paragraph>
            ...
            politics and confusion, boast high morale and productivity and very
            low turnover of good people. 180 Decibels provides objective metrics
            and removes the complexity from managing your team.
          </Typography>
