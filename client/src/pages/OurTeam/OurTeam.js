...
const OurTeam = ({ location, classes }) => (
  ...
  >
    ...
    <Typography variant="body1" paragraph>
      ...
      built products and services, grown (and shrunk) teams in high-growth (and
      stagnant) environments and faced most of the challenges you have either
    ...
    <Grid container className={classes.founder}>
      ...
      <Grid item xs={12}>
        <Quote right className={classes.quote} cite="Chris, Board Chair">
          ...
          thought out package and exposed us to the kinds of questions we should
          be asking. He helped us focus on the most important issues and kept us
          from becoming mired in too much extraneous detail.
        </Quote>
      </Grid>
    </Grid>
    ...
    <Grid container className={classes.founder}>
      ...
      <Grid item xs>
        ...
        <Typography variant="body1" paragraph>
          ...
          customer relationships, develop and motivate teams, and create urgency
          in organizations. Her straightforward, results-based approach to
          serving clients is matched only by her empathy and concern for
          affecting real change.
        </Typography>
      </Grid>
      <Grid item xs={12}>
        <Quote right className={classes.quote} cite="Derek, CEO">
          Kerri is an exceptionally talented individual who expertly seized and
          and excelled with any aspect of the business that I asked her to
          tackle. She has a remarkable ability to connect with her team, her
          peers, and all the key stakeholders of the venture, both internal and
          external.
        </Quote>
      </Grid>
    </Grid>
    ...
    <Grid container className={classes.founder}>
      ...
      <Grid item xs={12}>
        <Quote right className={classes.quote} cite="Derek, CEO">
          ...
          Jared has architected and implemented many solutions, all successfully
