      ...
      <section>
        ...
        <Grid container className={classes.founder}>
          ...
          <Grid item xs>
            ...
            <Typography variant="body1" paragraph>
              ...
              companies from start-up to exit. He is fanatical about learning
              and implementing world-class operational practices.
            </Typography>
          </Grid>
          <Grid item xs={12}>
            <Quote right className={classes.quote} cite="Chris, Board Chair">
              Dayton brings an abundance of obvious business experience in a
              well thought out package and exposed us to the kinds of questions
              we should be asking. He helped us focus on the most important
              issues and kept us from becoming mired in too much extraneous
              detail.
            </Quote>
          </Grid>
        </Grid>
        ...
        <Grid container className={classes.founder}>
          ...
          <Grid item xs>
            ...
            <Typography variant="body1" paragraph>
              Kerri has deep experience in high growth, venture-backed
              technology start-ups nationwide. She has a proven ability to
              initiate and build customer relationships, develop and motivate
              teams, and create urgency in organizations. Her straightforward,
              results-based approach to serving clients is matched only by her
              empathy and concern for affecting real change.
            </Typography>
          </Grid>
          <Grid item xs={12}>
            <Quote right className={classes.quote} cite="Derek, CEO">
              Kerri is an exceptionally talented individual who expertly seized
              and and excelled with any aspect of the business that I asked her
              to tackle. She has a remarkable ability to connect with her team,
              her peers, and all the key stakeholders of the venture, both
        ...
        <Grid container className={classes.founder}>
          ...
          <Grid item xs>
            ...
            <Typography variant="body1" paragraph>
              ...
              meets business street smarts. From data to web, project to
              product, Jared maxes out value and turns vision into reality. He
              came to 180 after building a blockchain platform for an industry
              front-runner.
            </Typography>
          </Grid>
          <Grid item xs={12}>
